...
class CurseBotApp(ctk.CTk):
    def __init__(self, bot_manager=None):
        ...
        # BotManager — optioneel maar probeer ook auto-import uit launch
        self._bot_manager = bot_manager
        if self._bot_manager is None:
            try:
                from launch import bot_manager as _bm
                self._bot_manager = _bm
            except Exception:
                pass
    ...
    def _build_footer(self):
        ...
        self.ftr_version_lbl = ctk.CTkLabel(
            self.ftr_frame, text="CurseBot v3.1",
    ...
    def _toast(self, msg: str):
        ...
        self.after(3000, lambda: self.ftr_version_lbl.configure(
            text="CurseBot v3.1", text_color=C_MUTED
        ))
...
# ╔══════════════════════════════════════════════════════════════════════╗
# ║  File: ui/app.py │ v3.1.0 │ 2026-06-06                            ║
