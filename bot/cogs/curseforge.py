"""
CurseBot — cogs/curseforge.py
Hoofd-monitor cog. Pollt CurseForge elke N minuten voor alle projecten van DieOuwe.
Detecteert nieuwe releases en stuurt Discord embeds.
"""
import discord
